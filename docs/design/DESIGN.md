...
- **2026-09-07 — окно быстрого перехода ничего не меняет.** По `Ctrl+K`
  ...
  Сочетание проверено на свободу: обработчика на него в клиентских пакетах ядра
  нет. Пересмотр — если ядро займёт сочетание.
